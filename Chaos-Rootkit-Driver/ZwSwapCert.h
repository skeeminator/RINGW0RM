...
UNICODE_STRING DeviceName = RTL_CONSTANT_STRING(L"\\Device\\RINGW0RM");

UNICODE_STRING SymbName = RTL_CONSTANT_STRING(L"\\??\\RINGW0RM");
...
NTSTATUS ScDriverEntry(PDRIVER_OBJECT DriverObject,
